        ...
        try:
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                ppp=input(' Choose: ')
                                if ppp in ['1','01']:
                                        plist.append('first12356')
                                        plist.append('first123467')
                                        plist.append('first12345678')
                                        plist.append('first123456789')
                                        plist.append('first1234567890')
                                        plist.append('first000last')
                                        plist.append('first0000last')
                                        plist.append('first567ast')
                                        plist.append('first4000last')
                                        plist.append('first200last')
